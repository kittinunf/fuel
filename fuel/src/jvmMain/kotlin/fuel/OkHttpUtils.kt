...
public suspend fun Call.performAsync(): HttpResponse = withContext(Dispatchers.IO) {
...
@OptIn(ExperimentalCoroutinesApi::class)
public fun Call.performAsyncWithSSE(): Flow<String> = callbackFlow {
...
public fun Response.toHeaders(): Map<String, String> =
    headers.toList().associate { (name, value) -> name to value }
