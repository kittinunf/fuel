...
class RequestHeadersTest : BaseTestCase() {
    ...
    fun requestHeadersFromReadmeIntegrity() {
        val request = Request(method = Method.POST, path = "/my-post-path", url = URL("https://test.fuel.com/my-post-path"))
    ...
    fun requestHasHeaderGetter() {
        val request = Request(method = Method.GET, path = "/", url = URL("https://test.fuel.com/"))
