...
class Fuel {
    ...
    companion object {
        ...
        @JvmStatic
        @JvmOverloads
        fun upload(path: String, method: Method = Method.POST, parameters: Parameters? = null): MultipartRequest =
                FuelManager.instance.upload(path, method, parameters)

        @JvmStatic
        @JvmOverloads
        fun upload(convertible: PathStringConvertible, method: Method = Method.POST, parameters: Parameters? = null): MultipartRequest =
...
@JvmOverloads
fun String.httpUpload(method: Method = Method.POST, parameters: Parameters? = null): MultipartRequest =
        Fuel.upload(this, method, parameters)

@JvmOverloads
fun Fuel.PathStringConvertible.httpUpload(method: Method = Method.POST, parameters: Parameters? = null): MultipartRequest =
        Fuel.upload(this, method, parameters)
